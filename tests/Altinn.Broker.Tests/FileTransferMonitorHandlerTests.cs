...
public class FileTransferMonitorHandlerTests
{
    [Fact]
    public async Task CheckForStuckFileTransfers_WhenCalled_LogsInformation()
    {
        ...
        var monitorLogger = new Mock<ILogger<FileTransferMonitorHandler>>();
        var notifierLogger = new Mock<ILogger<SlackStuckFileTransferNotification>>();
        var hostEnvironment = new Mock<IHostEnvironment>();
        hostEnvironment.SetupGet(e => e.EnvironmentName).Returns("Test");
        var slackNotifier = new SlackStuckFileTransferNotification(notifierLogger.Object, slackClient.Object, hostEnvironment.Object);
        var handler = new FileTransferMonitorHandler(fileTransferStatusRepository.Object, slackNotifier, monitorLogger.Object);
