...
BEGIN
    ...
    ELSE
        ...
        BEGIN
            ...
            RAISE NOTICE 'Set pgaudit.log for Broker read role %', read_role_name;
        EXCEPTION
            WHEN OTHERS THEN
                RAISE NOTICE 'Could not set pgaudit.log for Broker read role %: %', read_role_name, SQLERRM;
        END;
    ...
    ELSE
        ...
        BEGIN
            ...
            RAISE NOTICE 'Set pgaudit.log for Broker write role %', write_role_name;
        EXCEPTION
            WHEN OTHERS THEN
                RAISE NOTICE 'Could not set pgaudit.log for Broker write role %: %', write_role_name, SQLERRM;
        END;
