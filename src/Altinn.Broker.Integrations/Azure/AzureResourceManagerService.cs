...
public class AzureResourceManagerService : IResourceManager
{
    ...
    public async Task Deploy(ResourceOwnerEntity resourceOwnerEntity)
    {
    ...
    public async Task<DeploymentStatus> GetDeploymentStatus(ResourceOwnerEntity resourceOwnerEntity)
    {
        ...
        var resourceGroupCollection = subscription.GetResourceGroups();
        var resourceGroupExists = await resourceGroupCollection.ExistsAsync(GetResourceGroupName(resourceOwnerEntity));
        ...
        var resourceGroup = await resourceGroupCollection.GetAsync(GetResourceGroupName(resourceOwnerEntity));
        var storageAccountCollection = resourceGroup.Value.GetStorageAccounts();
        var storageAccountExists = await storageAccountCollection.ExistsAsync(GetStorageAccountName(resourceOwnerEntity));
