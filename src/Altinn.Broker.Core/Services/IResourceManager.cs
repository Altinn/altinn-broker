...
{
    Task<DeploymentStatus> GetDeploymentStatus(ResourceOwnerEntity resourceOwnerEntity, CancellationToken ct);
    ...
    /// <returns></returns>
    Task Deploy(ResourceOwnerEntity resourceOwnerEntity, CancellationToken ct);
