...
public interface IFileTransferRepository
{
    ...
    Task<List<FileTransferSummaryEntity>> GetActiveFileTransferSummariesAssociatedWithActor(ActiveFileTransferSearchEntity fileTransferSearch, CancellationToken cancellationToken);
