...
var containerAppEnvVars = concat([
  ...
  { name: 'MaskinportenSettings__ClientId', secretRef: 'maskinporten-client-id' }
  {
    ...
    value: 'altinn:events.publish altinn:events.publish.admin altinn:register/partylookup.admin altinn:authorization/authorize.admin altinn:resourceregistry/resource.admin'
  }
  { 
